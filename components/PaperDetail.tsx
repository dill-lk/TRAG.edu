            ...
            <div className="lg:col-span-8 space-y-12">
                <div className="glass-card rounded-[3rem] p-12 md:p-16 relative overflow-hidden shadow-xl border-white/10">
                    ...
                    <div className="bg-slate-900 rounded-[2.5rem] p-10 flex flex-col md:flex-row items-center justify-between gap-8 shadow-xl">
                        ...
                        <button onClick={() => window.open(paper.file_url, '_blank')} className="w-full md:w-auto px-12 py-6 bg-blue-600 text-white rounded-2xl font-bold text-xs uppercase tracking-widest flex items-center justify-center gap-3 shadow-lg shadow-blue-500/30 hover:scale-105 transition-all"><Download size={20} /> Download PDF</button>
                    </div>
                </div>
