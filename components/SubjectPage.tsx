    ...
    <div className="max-w-6xl mx-auto pt-10 animate-in fade-in duration-700 pb-32">
        ...
        <div className="space-y-4">
            {activeTab === 'help' ? (
                ...
                <>
                {(activeTab === 'papers' ? papers : notes).map((item, idx) => (
                    <div 
                        key={item.id}
                        onClick={() => onNavigate(`#/paper/${item.id}`)}
                    ...
                    >
                        <div className={`w-14 h-14 rounded-2xl flex items-center justify-center shrink-0 transition-all ${activeTab === 'papers' ? 'bg-blue-100 dark:bg-blue-900/30 text-blue-600 group-hover:bg-blue-600 group-hover:text-white' : 'bg-emerald-100 dark:bg-emerald-900/30 text-emerald-600 group-hover:bg-emerald-600 group-hover:text-white'}`}>
                            <FileText size={24} />
                        </div>
                        ...
                        <div className="flex-grow">
                            <div className="flex items-center gap-2 mb-2">
                                ...
                                <span className="text-[8px] font-bold uppercase tracking-widest bg-blue-500/5 text-blue-600 px-3 py-1 rounded-full">{item.type}</span>
                            </div>
